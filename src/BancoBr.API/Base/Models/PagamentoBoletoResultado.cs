...
{
    /// <summary>
    /// Resultado de um pagamento de boleto, independente do banco. Cobre tanto o retorno direto
    /// do pagamento (200 com comprovante, 202 pendência de assinatura, 204 sem corpo) quanto os
    /// desvios possíveis no fluxo de duas etapas de consulta + pagamento (boleto não encontrado
    /// na consulta, ou pagamento bloqueado pelo banco) — representados explicitamente em vez de
    /// sobrecarregar um Comprovante nulo com múltiplos significados.
    /// </summary>
